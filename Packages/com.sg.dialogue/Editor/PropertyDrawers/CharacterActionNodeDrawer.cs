...
/// <summary>
/// 為 CharacterActionNode 結構提供一個自訂的 UIElements 編輯器介面。
/// </summary>
...
public class CharacterActionNodeDrawer : PropertyDrawer
{
    public override VisualElement CreatePropertyGUI(SerializedProperty property)
    {
        ...
        // var spriteSheetPresenterProp = property.FindPropertyRelative("spriteSheetPresenter");
        // var spriteSheetAnimationNameProp = property.FindPropertyRelative("spriteSheetAnimationName");
        //
        // // 建立基礎 UI 元素
        ...
        // var spriteSheetPresenterField = new PropertyField(spriteSheetPresenterProp);
        // var spriteSheetAnimationNameField = new PropertyField(spriteSheetAnimationNameProp);
        //
        ...
        // enterContainer.Add(spriteSheetPresenterField);
        // enterContainer.Add(spriteSheetAnimationNameField);
        //
        // // --- 其他設定 ---
        ...
        //         spriteSheetPresenterField.style.display = renderMode == PortraitRenderMode.SpriteSheet ? DisplayStyle.Flex : DisplayStyle.None;
        //         spriteSheetAnimationNameField.style.display = renderMode == PortraitRenderMode.SpriteSheet ? DisplayStyle.Flex : DisplayStyle.None;
        //     }
        //
        // }
        //
